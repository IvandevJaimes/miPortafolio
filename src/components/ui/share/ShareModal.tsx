...
export interface SharePlatform {
  id: string;
  name: string;
  icon: "twitter" | "linkedin" | "facebook" | "whatsapp" | "telegram" | "reddit";
...
const icons: Record<SharePlatform["icon"], ReactNode> = {
  twitter: (
...
export const ShareModal = ({
  ...
  return (
    <div className="share-modal-content" ref={menuRef}>
      ...
      {platforms.map((platform) => (
        <button
          key={platform.id}
          className={`share-option share-${platform.id}`}
          onClick={() => handleShare(platform)}
        >
          <div className="share-option-icon">{icons[platform.icon]}</div>
