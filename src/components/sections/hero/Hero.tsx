...
const texts = [
  { text: "Backend Developer", duration: 2 },
  { text: "Node.js", duration: 1.5 },
  { text: "TypeScript", duration: 1.5 },
  { text: "Express & React Developer", duration: 2.5 },
  { text: "APIs RESTful", duration: 1.5 },
];
      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-name">
            Ivan <span className="hero-name-accent">Jaimes</span>
          </h1>
          ...
          <p className="hero-description">
            Desarrollador Fullstack junior orientado al backend. Construyo APIs
            robustas y escalables con Node.js, TypeScript y Express, combinadas
            con interfaces modernas en React. Apasionado por la arquitectura de
            sistemas y el código limpio.
          </p>
